...
<head>
   ...
   <body class="hold-transition sidebar-mini">
    ...
    var fieldHTML = '<div style="display:flex;"><input type="text" name="sku[]" id="sku" placeholder="SKU" class="form-control" style="width:150px;margin-right:5px;margin-top:5px" /><input type="text" name="size[]" id="size" placeholder="Size" class="form-control" style="width:150px;margin-right:5px;margin-top:5px" /><input type="text" name="price[]" id="price" placeholder="Price" class="form-control" style="width:150px;margin-right:5px;margin-top:5px" /><input type="text" name="stock[]" id="stock" placeholder="Stock" class="form-control" style="width:150px;margin-right:5px;margin-top:5px" /><a href="javascript:void(0);" class=" btn btn-warning btn-xs remove_button" style="margin-top:5px;">Remove</a></div>'; //New input field html 
