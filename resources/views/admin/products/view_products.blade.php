                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                           ...
                                           <img src="{{asset('/uploads/products/'.$product->image)}}" alt="" style="width:90px;">
                                       </td>
                                       @endif
                                       <td>{{$product->price}}</td>
                                       <td>
                                       ...
                                       <td>
                                          ...
                                          <a href="{{url('admin/edit-product/'.$product->id)}}" class="btn btn-add btn-sm" title="Edit Products"><i class="fa fa-pencil"></i></button>
                                          <a href="{{url('admin/delete-product/'.$product->id)}}" class="btn btn-danger btn-sm" title="Delete Products"><i class="fa fa-trash-o"></i> </button>
                                       </td>
                                    </tr>
                                   @endforeach
                                 </tbody>
