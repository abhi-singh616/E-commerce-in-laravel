                           ...
                           <form class="col-sm-6" enctype="multipart/form-data" action="{{url('admin/add-attributes/'.$productDetails->id)}}" method="post"> {{csrf_field()}}
                              ...
                              <div class="field_wrapper">
                                    <div style="display:flex;">
                                        ...
                                        <input type="text" name="stock[]" id="stock" placeholder="Stock" class="form-control" style="width:150px;margin-right:5px;" />
                                        <a herf="javascript:void(0);" class="btn btn-info add_button" title="Add Field" style="margin-bottom:5px;">Add</a> 
